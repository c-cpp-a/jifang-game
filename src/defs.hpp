...
const string sprite_names[8]={"","lyr","xza","cyq","wcy","nmk","AJ","lxz"};
const string card_names[cardnums+1]={"","学新知识点","做题","狂人卷题","禁止内卷","腐败","一起腐败","向AJ举报","急眼","翻墙","机惨"};
const string skill_names[8][3]={//主动技能
	{},
	{"腐败王","制裁"},
	{},
	{"出题人"},
...
constexpr int skills[8]={0,2,0,1,1,1,0,1};//主动技能数
